...
--
-- Table structure for table `trans_backdate_requests`
--

DROP TABLE IF EXISTS `trans_backdate_requests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trans_backdate_requests` (
  ...
  CONSTRAINT `trans_backdate_requests_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `master_user` (`user_id`),
  CONSTRAINT `trans_backdate_requests_ibfk_2` FOREIGN KEY (`processed_by`) REFERENCES `master_user` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `trans_backdate_requests`
--

LOCK TABLES `trans_backdate_requests` WRITE;
/*!40000 ALTER TABLE `trans_backdate_requests` DISABLE KEYS */;
INSERT INTO `trans_backdate_requests` VALUES (1,6,4,'2025-05-08','TEST','approved',7,'2025-05-08 15:19:54','2025-05-08 09:48:54','2025-05-08 09:49:54','2025-05-11'),(2,6,22,'2025-05-08','HELLO','pending',NULL,NULL,'2025-05-08 10:00:32','2025-05-08 10:00:32','2025-05-11');
/*!40000 ALTER TABLE `trans_backdate_requests` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2025-05-08 15:40:39
